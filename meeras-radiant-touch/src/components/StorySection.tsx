        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-6">
              <span className="text-primary-rose">The Story of</span>
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="relative">
              {/* Founder/About image */}
              <div className="aspect-[4/5] rounded-2xl card-elegant overflow-hidden shadow-2xl">
                <img
                  src="/galleryphoto/ChatGPT Image Aug 5, 2025, 03_37_46 AM.png"
                  alt="Meera's Craftsmanship and Heritage"
